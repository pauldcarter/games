...
move ◀ ▶ on the left, rotate ↺ ↻ and DROP on the right, like a game controller.
Held in portrait, it asks you to rotate the phone. Tap the ⛶ button (top-right)
to go fullscreen and hide the browser's address bar, where the phone supports
it.
